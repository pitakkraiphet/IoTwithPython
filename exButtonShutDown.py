...
import time #import t he functions
import os #import OS library for Shutdown control

stopButton = Button(26) #defines the button as an ofject and chooses GPIO 26
